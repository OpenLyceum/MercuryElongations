/**
 * MercuryElongationsButtonOptions.ts
 *
...
export const LIGHT_SURFACE_TEXT_FILL = MercuryElongationsColors.controlSurfaceTextColorProperty;

/**
 * Combo-box chrome for panels. Item labels must use {@link LIGHT_SURFACE_TEXT_FILL}, not
 * {@link MercuryElongationsColors.textColorProperty} — that color is for labels on the dark panel fill.
 */
export const MERCURY_ELONGATIONS_COMBO_BOX_OPTIONS = {
  buttonFill: MercuryElongationsColors.controlSurfaceColorProperty,
  listFill: MercuryElongationsColors.controlSurfaceColorProperty,
  buttonStroke: MercuryElongationsColors.panelBorderColorProperty,
  listStroke: MercuryElongationsColors.panelBorderColorProperty,
...
export const TIME_CONTROL_SPEED_RADIO_OPTIONS = {
  speedRadioButtonGroupOptions: {
    labelOptions: { fill: MercuryElongationsColors.textColorProperty },
  },
